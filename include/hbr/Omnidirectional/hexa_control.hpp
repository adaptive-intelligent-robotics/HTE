#ifndef ROBOT_DART_CONTROL_HEXA_OMNI_CONTROL
#define ROBOT_DART_CONTROL_HEXA_OMNI_CONTROL
    ...
    namespace control {
        ...
        public:
            ...
            Eigen::VectorXd query(const std::shared_ptr<robot_dart::Robot>& robot, double t)
            {
                ...
                // if(t<0.02)
                //     std::cout<<"Params "<<_dt<<" Targets "<<t<<" "<<target_positions.tail(18).transpose()<<std::endl;
                ...
                // if(t<0.01)
                //     std::cout<<"Params "<<_dt<<" Velocity "<<t<<" "<<vel.tail(18).transpose()<<std::endl;
        ...
        protected:
            hexapod_controller::HexaOmniController _controller;
            double _dt;
            bool _h_params_set = false;
        };

        using HexaOmniControl = robot_dart::control::PolicyControl<HexaOmniPolicy>;
    } // namespace control
} // namespace robot_dart
